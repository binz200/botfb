...
return async (event) => {
    ...
    if (event.body && event.body.startsWith(prefix)) return api.sendMessage(" ", event.threadID);
      ...
      break;
       case "event":
          ...
          var msg = '\n[🐢]=== 『 UPDATE GROUP 』 ===[🦎]\n━━━━━━━━━━━━━━━━\n[🦐] »'
                ...
                body: `${msg}`, attachment: (await axios.get((await axios.get(`https://api-0703.0703-opa.repl.co/images/cosplay`)).data.url, {
                                responseType: 'stream'
                            })).data
            }, event.threadID);
                    }
